...
import com.example.springboottabelogkadai.form.StoreEditForm;
import com.example.springboottabelogkadai.form.StoreRegisterForm;
import com.example.springboottabelogkadai.repository.StoreRepository;
import com.example.springboottabelogkadai.service.StoreService;
...
public class AdminStoreController {
	...
	public String edit(@PathVariable(name = "id") Integer id, Model model ) {
		...
		StoreEditForm storeEditForm = new StoreEditForm(store.getId(), store.getName(), null, store.getDescription(), store.getPriceRange(), store.getBusinessHours(), store.getPostalCode(), store.getAddress(), store.getPhoneNumber());
